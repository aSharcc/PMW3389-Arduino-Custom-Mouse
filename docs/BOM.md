...
|---|---|---|---|
|Custom PCB|1|Yes|Manufacture by uploading [this](Hardware/v2_GBR_Files/v2_GBR_Files.zip) to a PCB manufacturer|

This PCB can be assembled by PCB manufacturer or assembled by hand.

## 2. Surface Mount Components (Placed in PCBA)

# CHECK CAPACITOR REFERENCES
...
|C1-5|5|Capacitor|0.1uF/100nF|0805|-|
|C6-8|3|Capacitor|10uF|0805|-|
...
|EC11|1|Rotary encoder (Scroll Wheel)|
...
- Quantity: 1
- Download [GBR Files](Hardware/v2_GBR_Files/v2_GBR_Files.zip)
