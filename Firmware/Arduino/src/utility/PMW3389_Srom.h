...
#include <Arduino.h> // Include the header file for program memory access

// SROM data for the PMW3389 sensor in program memory to save RAM space
const uint8_t PMW3389_SROM[4094] PROGMEM = { 
